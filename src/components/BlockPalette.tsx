...
export const BlockPalette: React.FC<BlockPaletteProps> = ({
  ...
  return (
    <div className="w-80 bg-gray-900/90 backdrop-blur-sm border-r border-gray-700/50 flex flex-col">
      <div className="p-4 border-b border-gray-700/50">
        ...
        <div className="relative mb-3">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 bg-gray-800/50 border border-gray-600/50 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-blue-500/50 focus:ring-1 focus:ring-blue-500/25"
          />
        </div>
        ...
        <div className="grid grid-cols-6 gap-2">
          {blocks.map((block) => (
            <button
              ...
              className={`
                relative w-8 h-8 border-2 transition-all duration-200 group
